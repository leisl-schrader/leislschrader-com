...
<head>
  ...
  <!-- Place favicon.ico and apple-touch-icon.png in the root directory: mathiasbynens.be/notes/touch-icons -->
	...
	<link rel="stylesheet" href="_css/stylesheets/master.css">
  ...
  <script src="_js/vendor/modernizr-2.5.3.min.js"></script>
</head>
<body>
  ...
  <header>
	...
	<h1>Leisl Schrader</h1>
  	...
  	<nav>
  		...
  		<a href="https://github.com/leisl-schrader?tab=repositories">Portfolio (GitHub)</a>
  	</nav>
  ...
  <div role="main">
  	...
  	<section id="resume">
  		<h3>Resume</h3>
  		<a href="public/leisl_schrader_resume.pdf">Download PDF</a>
  ...
  <script src="//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
	<script>window.jQuery || document.write('<script src="_js/vendor/jquery-1.8.3.min.js"><\/script>')</script>
	<script type="text/javascript" src="//use.typekit.net/zpw8mcj.js"></script>
